            ...
            <div class="col-12">
                <div class="card">
                    <div class="form-filter" style="width:1200px;margin-left: 300px">
                        <form action="/admin/administrators/index" method="get"
                              style="margin-top: 30px;margin-bottom: 20px;border: 1px solid #d7d4d4;padding: 10px">
                            @csrf
                            <select name="role" style="border-radius: 5px;height: 45px;margin-left: 30px">
                                    ...
                                    @if($u->role == 1)
                                        <td>
                                            ...
                                            <a onclick="return confirm('Are you comfirm delete this administrator?')"
                                               href="{{url("/admin/administrators/delete",["administrator"=>$item->id])}}"
