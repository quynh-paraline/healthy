            ...
            <div class="card">
                <div class="form-filter" style="width:1200px;margin-left: 300px">
                    <form wire:submit.prevent="filter"
                        ...
                        <input id="startDate" style="border-radius: 5px;height: 45px" type="date" wire:model.defer="startDate"
                               placeholder="Start Date">
                        <label style="margin-left: 30px" for="endDate">End date</label>
                        <input id="endDate" style="border-radius: 5px;height: 45px" type="date" wire:model.defer="endDate"
                               placeholder="End Date">
                        <select wire:model.defer="status" style="border-radius: 5px;height: 45px;margin-left: 30px" >
                        ...
                        <input style="border-radius: 5px;height: 45px;margin-left: 30px" type="text"
                               wire:model.defer="phone_number" placeholder="Phone number">
